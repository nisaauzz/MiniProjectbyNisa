...
public class DeletePage {
    ...
    @Step
    public String setEndpointCategories() {
        return endpointAuth + "/products/12510";
    }

    @Step
    public void sendReqDeleteCategories() {
        SerenityRest.given().header("Authorization", "Bearer " + token).delete(setEndpointCategories());    }
